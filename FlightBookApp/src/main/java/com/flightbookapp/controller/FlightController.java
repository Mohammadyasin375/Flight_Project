package com.flightbookapp.controller;
...
import com.flightbookapp.model.Flight;
import com.flightbookapp.repository.FlightRepository;

@RestController
@CrossOrigin(origins = {"http://localhost:4031/"})
